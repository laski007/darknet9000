...
{
    cl_read_array(l.weights_gpu, l.weights, l.inputs*l.outputs);
    cl_read_array(l.biases_gpu, l.biases, l.outputs);
    cl_read_array(l.weight_updates_gpu, l.weight_updates, l.inputs*l.outputs);
    cl_read_array(l.bias_updates_gpu, l.bias_updates, l.outputs);
    if (l.batch_normalize){
        cl_read_array(l.scales_gpu, l.scales, l.outputs);
        cl_read_array(l.rolling_mean_gpu, l.rolling_mean, l.outputs);
        cl_read_array(l.rolling_variance_gpu, l.rolling_variance, l.outputs);
    }
}

void push_connected_layer(connected_layer l)
{
    cl_write_array(l.weights_gpu, l.weights, l.inputs*l.outputs);
    cl_write_array(l.biases_gpu, l.biases, l.outputs);
    cl_write_array(l.weight_updates_gpu, l.weight_updates, l.inputs*l.outputs);
    cl_write_array(l.bias_updates_gpu, l.bias_updates, l.outputs);
    if (l.batch_normalize){
        cl_write_array(l.scales_gpu, l.scales, l.outputs);
        cl_write_array(l.rolling_mean_gpu, l.rolling_mean, l.outputs);
        cl_write_array(l.rolling_variance_gpu, l.rolling_variance, l.outputs);
    }
}
...
void forward_connected_layer_gpu(connected_layer l, network net)
{
    ...
    for(i = 0; i < l.batch; ++i){
	float * new = (float *) l.output_gpu;
	float * a_float = new + i*l.outputs;
	cl_mem a = (cl_mem) a_float;
        axpy_ongpu(l.outputs, 1, l.biases_gpu, 1, a/*l.output_gpu + i*l.outputs*/, 1);
    }
...
void backward_connected_layer_gpu(connected_layer l, network net)
{
    ...
    for(i = 0; i < l.batch; ++i){
	float * new = (float *) l.delta_gpu;
	float * a_float = new + i*l.outputs;
	cl_mem a = (cl_mem) a_float;
        axpy_ongpu(l.outputs, 1, a/*l.delta_gpu + i*l.outputs*/, 1, l.bias_updates_gpu, 1);
    }
