...
{
    cl_read_array(l.delta_gpu, l.delta, l.batch*l.inputs);
}

void push_cost_layer(cost_layer l)
{
    cl_write_array(l.delta_gpu, l.delta, l.batch*l.inputs);
}
...
void forward_cost_layer_gpu(cost_layer l, network net)
{
    ...
    cl_read_array(l.output_gpu, l.output, l.batch*l.inputs);
    l.cost[0] = sum_array(l.output, l.batch*l.inputs);
}
